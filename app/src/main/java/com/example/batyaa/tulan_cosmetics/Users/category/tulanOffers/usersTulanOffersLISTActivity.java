package com.example.batyaa.tulan_cosmetics.Users.category.tulanOffers;
...
import com.example.batyaa.tulan_cosmetics.category.TulanOffers.adminTULANaddOffersActivity;
...
public class usersTulanOffersLISTActivity extends AppCompatActivity implements RecyclerAdapter.OnItemClickListener ,NavigationView.OnNavigationItemSelectedListener
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new RecyclerAdapter(usersTulanOffersLISTActivity.this, mProducts);
        mRecyclerView.setAdapter(mAdapter);
        mAdapter.setOnItemClickListener(usersTulanOffersLISTActivity.this);
    ...
    public void onDeleteItemClick(int position)
    {
        ...
        imageRef.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void aVoid) {
                ...
                Toast.makeText(usersTulanOffersLISTActivity.this, "Item deleted", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        if (id == R.id.request)
        {
            ...
            messageButton.setOnClickListener(new View.OnClickListener()
            {
                ...
                public void onClick(View v)
                {
                    ...
                    {
                        Toast.makeText(usersTulanOffersLISTActivity.this, "Enter All the correct information please", Toast.LENGTH_SHORT).show();
                    }
                }
            });
