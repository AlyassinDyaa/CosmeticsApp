...
public class guestTulanListActivity extends AppCompatActivity implements RecyclerAdapter.OnItemClickListener ,NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        mAdapter = new RecyclerAdapter(guestTulanListActivity.this, mProducts);
        //  mRecyclerView.setAdapter(mAdapter);
        mAdapter.setOnItemClickListener(guestTulanListActivity.this);
        ...
        mDBListener = mDatabaseRef.addValueEventListener(new ValueEventListener()
        {
            ...
            {
                Toast.makeText(guestTulanListActivity.this, databaseError.getMessage(), Toast.LENGTH_SHORT).show();
    ...
    public boolean onNavigationItemSelected(MenuItem item)
    {
        ...
        {
            Intent itemP = new Intent(guestTulanListActivity.this, guestAboutUsActivity.class);
            startActivity(itemP);
        ...
        if (id == R.id.feedback)
        {
            Intent logout = new Intent(guestTulanListActivity.this, guestFeedbackActivity.class);
        ...
        if (id == R.id.leave)
        {
            Intent leave= new Intent(guestTulanListActivity.this, LoginActivity.class);
            startActivity(leave);
        }
