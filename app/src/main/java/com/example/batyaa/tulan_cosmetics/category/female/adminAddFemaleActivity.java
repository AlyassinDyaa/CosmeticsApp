...
public class adminAddFemaleActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_add_female);
        ...
        mProgressDialog = new ProgressDialog(adminAddFemaleActivity.this);

        mStorageRef = getInstance().getReference("female");
...
//*******************************************************************************************************************************************************************
        uploadBtn.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                {
                    Toast.makeText(adminAddFemaleActivity.this, "An Upload is Still in Progress", Toast.LENGTH_SHORT).show();
                }
                else
                {
...
//*******************************************************************************************************************************************************************
    ...
    public  void uploadFile()
    {
        ...
        if(mImageUri != null) {
         ...
         /*   uploadProgressBar.setVisibility(View.VISIBLE);
            ...
            StorageReference storageReference = getInstance().getReference().child("female");
                ...
                public void onSuccess(final UploadTask.TaskSnapshot taskSnapshot) {
                    imageFilePath.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                        ...
                        public void onSuccess(Uri uri) {
                            Toast.makeText(adminAddFemaleActivity.this, "Product Upload successful", Toast.LENGTH_LONG).show();
    ...
    {
        Intent intent = new Intent(this, femaleListActivity.class);
...
//*******************************************************************************************************************************************************************
    ...
    public boolean onNavigationItemSelected(MenuItem item)
    {
        ...
        if (id == R.id.nav_admin_Category) {
            Intent itemP = new Intent(adminAddFemaleActivity.this, CatgeoryActivity.class);
            startActivity(itemP);
        }
        if (id == R.id.nav_admin_tulan_Category) {
            Intent itemP = new Intent(adminAddFemaleActivity.this, tulanCategories.class);
            startActivity(itemP);
        }
        if (id == R.id.logout)
        {
            Intent logout = new Intent(adminAddFemaleActivity.this, LoginActivity.class);
