package com.example.batyaa.tulan_cosmetics.Users.category.female;
...
import com.example.batyaa.tulan_cosmetics.category.male.adminAddMaleActivity;
...
public class usersFemaleActivity extends AppCompatActivity implements RecyclerAdapter.OnItemClickListener ,NavigationView.OnNavigationItemSelectedListener
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new RecyclerAdapter(usersFemaleActivity.this, mProducts);
        mRecyclerView.setAdapter(mAdapter);
        mAdapter.setOnItemClickListener(usersFemaleActivity.this);
    ...
    public void onDeleteItemClick(int position)
    {
        ...
        imageRef.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void aVoid) {
                ...
                Toast.makeText(usersFemaleActivity.this, "Item deleted", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        if (id == R.id.request)
        {
            ...
            messageButton.setOnClickListener(new View.OnClickListener()
            {
                ...
                public void onClick(View v)
                {
                    ...
                    {
                        Toast.makeText(usersFemaleActivity.this, "Enter All the correct information please", Toast.LENGTH_SHORT).show();
                    }
                }
            });
