package com.example.batyaa.tulan_cosmetics.category.TulanMale;
...
public class adminTULANaddMaleActivity extends AppCompatActivity  implements NavigationView.OnNavigationItemSelectedListener
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_add_offers_list);
        ...
        mProgressDialog = new ProgressDialog(adminTULANaddMaleActivity.this);

        mStorageRef = getInstance().getReference("tulanm");
        mDatabaseRef = FirebaseDatabase.getInstance().getReference("tulanm");
        ...
        uploadBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mUploadTask != null && mUploadTask.isInProgress()) {
                    Toast.makeText(adminTULANaddMaleActivity.this, "An Upload is Still in Progress", Toast.LENGTH_SHORT).show();
                } else {
...
//*******************************************************************************************************************************************************************
    ...
    public void uploadFile() {
        ...
        if (mImageUri != null) {
         ...
         /*   uploadProgressBar.setVisibility(View.VISIBLE);
            ...
            StorageReference storageReference = getInstance().getReference().child("tulanm");
                ...
                public void onSuccess(final UploadTask.TaskSnapshot taskSnapshot) {
                    imageFilePath.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                        ...
                        public void onSuccess(Uri uri) {
                            Toast.makeText(adminTULANaddMaleActivity.this, "Product Upload successful", Toast.LENGTH_LONG).show();
    ...
    private void openImagesActivity() {
        Intent intent = new Intent(this, tulanMaleListActivity.class);
...
//*******************************************************************************************************************************************************************
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_admin_Category) {
            Intent itemP = new Intent(adminTULANaddMaleActivity.this, CatgeoryActivity.class);
            startActivity(itemP);
        }
        if (id == R.id.nav_admin_tulan_Category) {
            Intent itemP = new Intent(adminTULANaddMaleActivity.this, tulanCategories.class);
            startActivity(itemP);
        }
        if (id == R.id.logout)
        {
            Intent logout = new Intent(adminTULANaddMaleActivity.this, LoginActivity.class);
