...
public class adminTulanAddActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener
        {
  ...
  //  private ProgressBar uploadProgressBar;
    ...
    String mStorageFolderPath = "tulan_products_uploaded";
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
       ...
       // uploadProgressBar = findViewById(R.id.progress_bar);
        ...
        mStorageRef = getInstance().getReference("tulan_products_uploaded");
        ...
        mProgressDialog = new ProgressDialog(adminTulanAddActivity.this);
...
//*******************************************************************************************************************************************************************
        uploadBtn.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                {
                    Toast.makeText(adminTulanAddActivity.this, "An Upload is Still in Progress", Toast.LENGTH_SHORT).show();
                }
                else
                {
...
//*******************************************************************************************************************************************************************
    ...
    public  void uploadFile()
    {
        if(mImageUri != null)
        {
           ...
           /* uploadProgressBar.setVisibility(View.VISIBLE);
            ...
            StorageReference storageReference = getInstance().getReference().child("all_items");
                ...
                public void onSuccess(final UploadTask.TaskSnapshot taskSnapshot) {
                    imageFilePath.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                        ...
                        public void onSuccess(Uri uri) {
                            Toast.makeText(adminTulanAddActivity.this, "Product Upload successful", Toast.LENGTH_LONG).show();
    ...
    {
        Intent intent = new Intent(this, tulanItemsActivity.class);
...
//*******************************************************************************************************************************************************************
    ...
    public boolean onNavigationItemSelected(MenuItem item)
    {
        ...
        if (id == R.id.nav_admin_Category) {
            /*Intent itemP = new Intent(adminTulanAddActivity.this, CatgeoryActivity.class);
            startActivity(itemP);*/
        }

        if (id == R.id.logout)
        {
            Intent logout = new Intent(adminTulanAddActivity.this, LoginActivity.class);
