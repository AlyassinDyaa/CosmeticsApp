package com.example.batyaa.tulan_cosmetics.Users.category.tulanMale;
...
import com.example.batyaa.tulan_cosmetics.category.TulanMale.adminTULANaddMaleActivity;
...
public class usersTulanMaleLISTActivity extends AppCompatActivity implements RecyclerAdapter.OnItemClickListener ,NavigationView.OnNavigationItemSelectedListener
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new RecyclerAdapter(usersTulanMaleLISTActivity.this, mProducts);
        mRecyclerView.setAdapter(mAdapter);
        mAdapter.setOnItemClickListener(usersTulanMaleLISTActivity.this);
        ...
        if (id == R.id.request)
        {
            ...
            messageButton.setOnClickListener(new View.OnClickListener()
            {
                ...
                public void onClick(View v)
                {
                    ...
                    {
                        Toast.makeText(usersTulanMaleLISTActivity.this, "Enter All the correct information please", Toast.LENGTH_SHORT).show();
                    }
                }
            });
