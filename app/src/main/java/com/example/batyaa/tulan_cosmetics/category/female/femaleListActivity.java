package com.example.batyaa.tulan_cosmetics.category.female;
...
public class femaleListActivity extends AppCompatActivity implements RecyclerAdapter.OnItemClickListener ,NavigationView.OnNavigationItemSelectedListener
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new RecyclerAdapter(femaleListActivity.this, mProducts);
        mRecyclerView.setAdapter(mAdapter);
        mAdapter.setOnItemClickListener(femaleListActivity.this);

        mStorage = getInstance();
        mDatabaseRef = FirebaseDatabase.getInstance().getReference("female");
        ...
        mDBListener = mDatabaseRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(DatabaseError databaseError) {
                Toast.makeText(femaleListActivity.this, databaseError.getMessage(), Toast.LENGTH_SHORT).show();
    ...
    public void onDeleteItemClick(int position)
    {
        ...
        imageRef.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void aVoid) {
                ...
                Toast.makeText(femaleListActivity.this, "Item deleted", Toast.LENGTH_SHORT).show();
            }
        });
...
/*
    ...
    {
        AlertDialog.Builder builder = new AlertDialog.Builder(femaleListActivity.this);
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                mQuery.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        Toast.makeText(femaleListActivity.this, "Product Deleted Successfully..", Toast.LENGTH_SHORT).show();
                    }
                    @Override
                ...
                mImageRefe.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        Toast.makeText(femaleListActivity.this, "Item was Deleted successfully...", Toast.LENGTH_SHORT).show();
                    }
                }).addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        //Unable to delete
                        Toast.makeText(femaleListActivity.this, "Can't delete", Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        {
            startActivity(new Intent(femaleListActivity.this, adminAddFemaleActivity.class));
            return true;
        }
    ...
    public boolean onNavigationItemSelected(MenuItem item)
    {
        ...
        if (id == R.id.nav_admin_Category) {
            Intent itemP = new Intent(femaleListActivity.this, CatgeoryActivity.class);
            startActivity(itemP);
        }
        if (id == R.id.nav_admin_tulan_Category) {
            Intent itemP = new Intent(femaleListActivity.this, tulanCategories.class);
            startActivity(itemP);
        }
        if (id == R.id.logout)
        {
            Intent logout = new Intent(femaleListActivity.this, LoginActivity.class);
