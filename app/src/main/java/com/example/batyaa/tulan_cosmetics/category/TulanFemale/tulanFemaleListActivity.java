...
public class tulanFemaleListActivity extends AppCompatActivity implements RecyclerAdapter.OnItemClickListener ,NavigationView.OnNavigationItemSelectedListener
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tulan_female_list);
        ...
        mAdapter = new RecyclerAdapter(tulanFemaleListActivity.this, mProducts);
        mRecyclerView.setAdapter(mAdapter);
        mAdapter.setOnItemClickListener(tulanFemaleListActivity.this);
        ...
        mDBListener = mDatabaseRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(DatabaseError databaseError) {
                Toast.makeText(tulanFemaleListActivity.this, databaseError.getMessage(), Toast.LENGTH_SHORT).show();
    ...
    public void onDeleteItemClick(int position)
    {
        ...
        imageRef.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void aVoid) {
                ...
                Toast.makeText(tulanFemaleListActivity.this, "Item deleted", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    {
        AlertDialog.Builder builder = new AlertDialog.Builder(tulanFemaleListActivity.this);
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                mQuery.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        Toast.makeText(tulanFemaleListActivity.this, "Product Deleted Successfully..", Toast.LENGTH_SHORT).show();
                    }
                    @Override
                ...
                mImageRefe.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        Toast.makeText(tulanFemaleListActivity.this, "Item was Deleted successfully...", Toast.LENGTH_SHORT).show();
                    }
                }).addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        //Unable to delete
                        Toast.makeText(tulanFemaleListActivity.this, "Can't delete", Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        {
            startActivity(new Intent(tulanFemaleListActivity.this, adminTULANaddFemaleActivity.class));
            return true;
        }
    ...
    public boolean onNavigationItemSelected(MenuItem item)
    {
        ...
        if (id == R.id.nav_admin_Category) {
            Intent itemP = new Intent(tulanFemaleListActivity.this, CatgeoryActivity.class);
            startActivity(itemP);
        }
        if (id == R.id.nav_admin_tulan_Category) {
            Intent itemP = new Intent(tulanFemaleListActivity.this, tulanCategories.class);
            startActivity(itemP);
        }
        if (id == R.id.logout)
        {
            Intent logout = new Intent(tulanFemaleListActivity.this, LoginActivity.class);
