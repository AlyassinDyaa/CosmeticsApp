...
public class maleListActivity extends AppCompatActivity  implements RecyclerAdapter.OnItemClickListener ,NavigationView.OnNavigationItemSelectedListener
{
...
//**** Setting up the Sort from Newest to oldest
        ...
        mAdapter = new RecyclerAdapter(maleListActivity.this, mProducts);
        mRecyclerView.setAdapter(mAdapter);
        mAdapter.setOnItemClickListener(maleListActivity.this);
    ...
    public void onDeleteItemClick(int position)
    {
        ...
        imageRef.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void aVoid) {
                ...
                Toast.makeText(maleListActivity.this, "Item deleted", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    {
        AlertDialog.Builder builder = new AlertDialog.Builder(maleListActivity.this);
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                mQuery.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        Toast.makeText(maleListActivity.this, "Product Deleted Successfully..", Toast.LENGTH_SHORT).show();
                    }
                    @Override
                    public void onCancelled(@NonNull DatabaseError databaseError) {
                        // if anything goes wrong
                        Toast.makeText(maleListActivity.this, databaseError.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
                ...
                mImageRefe.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        Toast.makeText(maleListActivity.this, "Item was Deleted successfully...", Toast.LENGTH_SHORT).show();
                    }
                }).addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        //Unable to delete
                        Toast.makeText(maleListActivity.this, "Can't delete", Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        {
            startActivity(new Intent(maleListActivity.this, adminAddMaleActivity.class));
            return true;
        }
    ...
    public boolean onNavigationItemSelected(MenuItem item)
    {
        ...
        if (id == R.id.nav_admin_Category) {
            Intent itemP = new Intent(maleListActivity.this, CatgeoryActivity.class);
            startActivity(itemP);
        }
        if (id == R.id.nav_admin_tulan_Category) {
            Intent itemP = new Intent(maleListActivity.this, tulanCategories.class);
            startActivity(itemP);
        }
        if (id == R.id.logout)
        {
            Intent logout = new Intent(maleListActivity.this, LoginActivity.class);
