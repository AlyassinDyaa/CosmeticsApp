package com.example.batyaa.tulan_cosmetics.category.Offers;
...
public class adminAddOffersList extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mProgressDialog = new ProgressDialog(adminAddOffersList.this);

        mStorageRef = getInstance().getReference("offers");
        ...
        uploadBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mUploadTask != null && mUploadTask.isInProgress()) {
                    Toast.makeText(adminAddOffersList.this, "An Upload is Still in Progress", Toast.LENGTH_SHORT).show();
                } else {
    ...
    public void uploadFile() {
        ...
        if (mImageUri != null) {
         ...
         /*   uploadProgressBar.setVisibility(View.VISIBLE);
            ...
            StorageReference storageReference = getInstance().getReference().child("offers");
                ...
                public void onSuccess(final UploadTask.TaskSnapshot taskSnapshot) {
                    imageFilePath.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                        ...
                        public void onSuccess(Uri uri) {
                            Toast.makeText(adminAddOffersList.this, "Product Upload successful", Toast.LENGTH_LONG).show();
...
//*******************************************************************************************************************************************************************
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_admin_Category) {
            Intent itemP = new Intent(adminAddOffersList.this, CatgeoryActivity.class);
            startActivity(itemP);
        }
        if (id == R.id.nav_admin_tulan_Category) {
            Intent itemP = new Intent(adminAddOffersList.this, tulanCategories.class);
            startActivity(itemP);
        }
        if (id == R.id.logout)
        {
            Intent logout = new Intent(adminAddOffersList.this, LoginActivity.class);
