package com.example.batyaa.tulan_cosmetics.category.TulanOffers;
...
public class adminTULANaddOffersActivity extends AppCompatActivity  implements NavigationView.OnNavigationItemSelectedListener
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_tulanadd_offers);
        ...
        mProgressDialog = new ProgressDialog(adminTULANaddOffersActivity.this);

        mStorageRef = getInstance().getReference("tulanOffers");
        mDatabaseRef = FirebaseDatabase.getInstance().getReference("tulanOffers");
        ...
        uploadBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mUploadTask != null && mUploadTask.isInProgress()) {
                    Toast.makeText(adminTULANaddOffersActivity.this, "An Upload is Still in Progress", Toast.LENGTH_SHORT).show();
                } else {
...
//*******************************************************************************************************************************************************************
    ...
    public void uploadFile() {
        ...
        if (mImageUri != null) {
         ...
         /*   uploadProgressBar.setVisibility(View.VISIBLE);
            ...
            StorageReference storageReference = getInstance().getReference().child("tulanOffers");
                ...
                public void onSuccess(final UploadTask.TaskSnapshot taskSnapshot) {
                    imageFilePath.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                        ...
                        public void onSuccess(Uri uri) {
                            Toast.makeText(adminTULANaddOffersActivity.this, "Product Upload successful", Toast.LENGTH_LONG).show();
    ...
    private void openImagesActivity() {
        Intent intent = new Intent(this, tulanOffersListActivity.class);
...
//*******************************************************************************************************************************************************************
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_admin_Category) {
            Intent itemP = new Intent(adminTULANaddOffersActivity.this, CatgeoryActivity.class);
            startActivity(itemP);
        }
        if (id == R.id.nav_admin_tulan_Category) {
            Intent itemP = new Intent(adminTULANaddOffersActivity.this, tulanCategories.class);
            startActivity(itemP);
        }
        if (id == R.id.logout)
        {
            Intent logout = new Intent(adminTULANaddOffersActivity.this, LoginActivity.class);
