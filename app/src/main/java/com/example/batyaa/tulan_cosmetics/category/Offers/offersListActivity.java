...
public class offersListActivity extends AppCompatActivity  implements RecyclerAdapter.OnItemClickListener ,NavigationView.OnNavigationItemSelectedListener
{
...
//**** Setting up the Sort from Newest to oldest
        ...
        mAdapter = new RecyclerAdapter(offersListActivity.this, mProducts);
        mRecyclerView.setAdapter(mAdapter);
        mAdapter.setOnItemClickListener(offersListActivity.this);
    ...
    public void onDeleteItemClick(int position)
    {
        ...
        imageRef.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void aVoid) {
                ...
                Toast.makeText(offersListActivity.this, "Item deleted", Toast.LENGTH_SHORT).show();
            }
        });
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                mQuery.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        Toast.makeText(offersListActivity.this, "Product Deleted Successfully..", Toast.LENGTH_SHORT).show();
                    }
                    @Override
                    public void onCancelled(@NonNull DatabaseError databaseError) {
                        // if anything goes wrong
                        Toast.makeText(offersListActivity.this, databaseError.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
                ...
                mImageRefe.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        Toast.makeText(offersListActivity.this, "Item was Deleted successfully...", Toast.LENGTH_SHORT).show();
                    }
                }).addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        //Unable to delete
                        Toast.makeText(offersListActivity.this, "Can't delete", Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        {
            startActivity(new Intent(offersListActivity.this, adminAddOffersList.class));
            return true;
        }
    ...
    public boolean onNavigationItemSelected(MenuItem item)
    {
        ...
        if (id == R.id.nav_admin_Category) {
            Intent itemP = new Intent(offersListActivity.this, CatgeoryActivity.class);
            startActivity(itemP);
        }
        if (id == R.id.nav_admin_tulan_Category) {
            Intent itemP = new Intent(offersListActivity.this, tulanCategories.class);
            startActivity(itemP);
        }
        if (id == R.id.logout)
        {
            Intent logout = new Intent(offersListActivity.this, LoginActivity.class);
