...
public class ItemsActivity extends AppCompatActivity implements RecyclerAdapter.OnItemClickListener ,NavigationView.OnNavigationItemSelectedListener{
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                mQuery.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        Toast.makeText(ItemsActivity.this, "Product Deleted Successfully..", Toast.LENGTH_SHORT).show();
                    }
                    @Override
                ...
                mImageRefe.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        Toast.makeText(ItemsActivity.this, "Item was Deleted successfully...", Toast.LENGTH_SHORT).show();
                    }
                }).addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        //Unable to delete
                        Toast.makeText(ItemsActivity.this, "Can't delete", Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
...
//*************************************************************************************************************************************
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        {
            startActivity(new Intent(ItemsActivity.this, adminAddActivity.class));
            return true;
        }
    ...
    public boolean onNavigationItemSelected(MenuItem item)
    {
        ...
        if (id == R.id.logout)
        {
            Intent logout = new Intent(ItemsActivity.this, LoginActivity.class);
