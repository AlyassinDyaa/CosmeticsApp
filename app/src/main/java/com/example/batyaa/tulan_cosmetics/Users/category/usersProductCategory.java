...
import com.example.batyaa.tulan_cosmetics.Adapters.usersCategoryRecyclerAdapter;
...
public class usersProductCategory extends AppCompatActivity implements RecyclerAdapter.OnItemClickListener,NavigationView.OnNavigationItemSelectedListener
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_users_product_category);
        ...
        usersCategoryRecyclerAdapter adapter = new usersCategoryRecyclerAdapter(this, mProducts);
        ...
        if (id == R.id.request)
        {
            ...
            messageButton.setOnClickListener(new View.OnClickListener()
            {
                ...
                public void onClick(View v)
                {
                    ...
                    {
                        Toast.makeText(usersProductCategory.this, "Enter All the correct information please", Toast.LENGTH_SHORT).show();
                    }
                }
            });
