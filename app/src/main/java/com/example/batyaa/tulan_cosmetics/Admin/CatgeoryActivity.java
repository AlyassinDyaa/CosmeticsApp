...
import com.example.batyaa.tulan_cosmetics.FIREBASE_CATEGORY.categoryDetailRecyclerActvity;
...
public class CatgeoryActivity extends AppCompatActivity  implements RecyclerAdapter.OnItemClickListener,NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_catgeory);
        ...
        CategoryRecyclerAdapter adapter = new CategoryRecyclerAdapter(this, mProducts);
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        {
//            startActivity(new Intent(CatgeoryActivity.this, adminAddCategoryActivity.class));
//            return true;
        }
