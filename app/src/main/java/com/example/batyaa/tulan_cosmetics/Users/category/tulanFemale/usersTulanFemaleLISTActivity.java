package com.example.batyaa.tulan_cosmetics.Users.category.tulanFemale;
...
import com.example.batyaa.tulan_cosmetics.category.female.adminAddFemaleActivity;
...
public class usersTulanFemaleLISTActivity extends AppCompatActivity implements RecyclerAdapter.OnItemClickListener ,NavigationView.OnNavigationItemSelectedListener
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new RecyclerAdapter(usersTulanFemaleLISTActivity.this, mProducts);
        mRecyclerView.setAdapter(mAdapter);
        mAdapter.setOnItemClickListener(usersTulanFemaleLISTActivity.this);
    ...
    public void onDeleteItemClick(int position)
    {
        ...
        imageRef.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void aVoid) {
                ...
                Toast.makeText(usersTulanFemaleLISTActivity.this, "Item deleted", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        if (id == R.id.request)
        {
            ...
            messageButton.setOnClickListener(new View.OnClickListener()
            {
                ...
                public void onClick(View v)
                {
                    ...
                    {
                        Toast.makeText(usersTulanFemaleLISTActivity.this, "Enter All the correct information please", Toast.LENGTH_SHORT).show();
                    }
                }
            });
