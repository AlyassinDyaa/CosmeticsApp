package com.example.batyaa.tulan_cosmetics.category.TulanFemale;
...
public class adminTULANaddFemaleActivity extends AppCompatActivity  implements NavigationView.OnNavigationItemSelectedListener
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_tulanadd_female);
        ...
        mProgressDialog = new ProgressDialog(adminTULANaddFemaleActivity.this);

        mStorageRef = getInstance().getReference("tulan_female");
        mDatabaseRef = FirebaseDatabase.getInstance().getReference("tulan_female");
        ...
        uploadBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mUploadTask != null && mUploadTask.isInProgress()) {
                    Toast.makeText(adminTULANaddFemaleActivity.this, "An Upload is Still in Progress", Toast.LENGTH_SHORT).show();
                } else {
...
//*******************************************************************************************************************************************************************
    ...
    public void uploadFile() {
        ...
        if (mImageUri != null) {
         ...
         /*   uploadProgressBar.setVisibility(View.VISIBLE);
            ...
            StorageReference storageReference = getInstance().getReference().child("tulan_female");
                ...
                public void onSuccess(final UploadTask.TaskSnapshot taskSnapshot) {
                    imageFilePath.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                        ...
                        public void onSuccess(Uri uri) {
                            Toast.makeText(adminTULANaddFemaleActivity.this, "Product Upload successful", Toast.LENGTH_LONG).show();
                            if (priceEDT.getText().toString() == "") {
                                Product upload = new Product(nameEditText.getText().toString().trim(), uri.toString(), descriptionEditText.getText().toString(), "NULL", cateET.getText().toString(), nameEditText.getText().toString().toLowerCase(), sizeEditText.getText().toString(), stockInventory.getText().toString());
                                ...
                                Product upload = new Product(nameEditText.getText().toString().trim(), uri.toString(), descriptionEditText.getText().toString(), priceEDT.getText().toString(), cateET.getText().toString(), nameEditText.getText().toString().toLowerCase(), sizeEditText.getText().toString(), stockInventory.getText().toString());
                                String uploadId = mDatabaseRef.push().getKey();
                                mDatabaseRef.child(uploadId).setValue(upload);
                                // uploadProgressBar.setVisibility(View.INVISIBLE);
                                mProgressDialog.dismiss();
    ...
    private void openImagesActivity() {
        Intent intent = new Intent(this, tulanFemaleListActivity.class);
...
//*******************************************************************************************************************************************************************
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_admin_Category) {
            Intent itemP = new Intent(adminTULANaddFemaleActivity.this, CatgeoryActivity.class);
            startActivity(itemP);
        }
        if (id == R.id.nav_admin_tulan_Category) {
            Intent itemP = new Intent(adminTULANaddFemaleActivity.this, tulanCategories.class);
            startActivity(itemP);
        }
        if (id == R.id.logout)
        {
            Intent logout = new Intent(adminTULANaddFemaleActivity.this, LoginActivity.class);
